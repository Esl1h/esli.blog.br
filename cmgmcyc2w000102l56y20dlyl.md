...
* **Phaser / Flanger** – Modulação de fase e delay curto.
...
* **Tecnologias** – R2R (preciso), Delta-Sigma (comum).
...
* **LMMS** – Livre, voltado à música eletrônica.
...
* **LUFS / RMS / Peak Meter** – Medidas de loudness e energia.
